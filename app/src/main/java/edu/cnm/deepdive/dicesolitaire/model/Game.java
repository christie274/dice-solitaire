...
public class Game {
  ...
  public static final int NUM_DICE = NUM_SCRATCHES + NUM_SETS * NUM_SETS;
  public static final int NUM_FACE = 6;
  public static final int MIN_SET_VALUE = SET_SIZE;
  public static final int MAX_SET_VALUE = SET_SIZE * NUM_FACE;
  ...
  private final int[] scratchCounts = new int[NUM_FACE];
  ...
  public boolean incrementScratchCount(int scratchValue) {
    ...
    if (count < MAX_SCRATCH_COUNT) {
      count++;
      scratchCounts[scratchValue - 1] = count;
      return true;
    } else {
      return false;
    }
